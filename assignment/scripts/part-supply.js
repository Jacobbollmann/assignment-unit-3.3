...
console.log('Last item removed from array:', removedItem);
...
for (let sum of supplyChanges) {
  totalParts+= sum;
}
console.log('The total parts amount is:', totalParts);
...
console.log(`We have ${parts} parts leftover.`);
